...
static void lcd_main_menu()
{
    ...
    //MENU_ITEM(submenu, MSG_CONTROL, lcd_control_menu); // remove "control" menu 2016-02-02
#ifdef SDSUPPORT
    if (card.cardOK)
    {
        if (card.isFileOpen())
...
static void lcd_prepare_menu()
{
    ...
    //MENU_ITEM(submenu, MSG_PREHEAT_ABS, lcd_preheat_abs_menu);  // remove pla 2016-02-02
  #else
    MENU_ITEM(function, MSG_PREHEAT_PLA, lcd_preheat_pla0);
    //MENU_ITEM(function, MSG_PREHEAT_ABS, lcd_preheat_abs0);     // remove abs 2016-02-02
  #endif
#endif
